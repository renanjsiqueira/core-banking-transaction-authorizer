...
/**
 * Centralized error handling, producing RFC 7807 {@link ProblemDetail} responses.
 *
 * <ul>
 *   <li>request validation / malformed body / bad path type → 400</li>
 *   <li>unsupported currency / invalid transaction → 400</li>
 *   <li>account not found → 404</li>
 *   <li>idempotency conflict → 409</li>
